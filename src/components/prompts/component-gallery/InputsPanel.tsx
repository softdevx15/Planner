          ...
          element: (
            <div style={sampleWidthStyle} className="space-y-[var(--space-2)]">
              ...
              <a
                ...
                className="inline-flex items-center gap-[var(--space-1)] text-label font-medium text-accent-foreground transition-colors duration-motion-sm ease-out hover:text-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--focus)] focus-visible:ring-offset-2 focus-visible:ring-offset-[hsl(var(--bg))]"
              >
