...
export default function SearchBar({
  ...
  const variantFieldClasses =
    variant === "neo"
      ? "hero2-neomorph !border border-[hsl(var(--border)/0.4)] !shadow-neo-soft hover:!shadow-neo-soft active:!shadow-neo-soft focus-within:!shadow-neo-soft [--hover:transparent] [--active:transparent]"
      : undefined;
